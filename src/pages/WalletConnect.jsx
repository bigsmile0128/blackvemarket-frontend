...
const signCertID = () => {
    vendor
        .sign("cert", {
            ...
            payload: {
                type: "text",
                content: "Welcome to BlackVeMarket. The place to be if you like NFTs other markets can't afford."
            }
        })
        .request()
        .then((r) => {
        ...
        [
            {
                ...
                description: 'Official VeChain wallet for mobile. Ios and android supported'
            },
            {
                img: img2,
                title: 'Sync2',
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <h5 className="sub-title ct style-1 pad-400">
                                We do not own any of your personal information. If someone ever asks about it in name of BlackV please report.
                            </h5>
                        </div>
                        <div className="col-md-12">
                            <div className="sc-box-icon-inner style-2">
                                {
                                    data.map((item,index) => (
                                        <div onClick={signCertID} skey={index} className="sc-box-icon">
                                            <div className="img">
