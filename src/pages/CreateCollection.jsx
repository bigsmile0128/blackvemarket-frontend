                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-9 col-lg-6 col-md-12 col-12">
                            <div className="form-profile">
                                ...
                                <form action="#">
                                    <h4 className="title-create-item mg-t-20">
                                        Logo Image
                                    </h4>
                                ...
                                <div className="flat-tabs tab-create-item">
                                    ...
                                    <Tabs>
                                        <h4 className="title-create-item mg-20">
                                            Name
                                        </h4>
                                        <input
                                            type="text"
                                        ...
                                        <p>
                                            adding a category will help make
                                            your item discoverable on vechain
                                        </p>
                                        ...
                                        <p className="mg-t-10">
                                            Select the blockchain where you'd
                                            like new items from this collection
                                        ...
                                        <div className="inner-row-form style-2 mg-t-20">
                                            ...
                                            <h3 className="mg-t-20">
                                                Payment tokens
                                            </h3>
                                            <p className="mg-t-20">
                                                Select the blockcain where you'd
                                                like new items from this
                                                collection to be added by
                                                default.
                                            </p>
                                        </div>
