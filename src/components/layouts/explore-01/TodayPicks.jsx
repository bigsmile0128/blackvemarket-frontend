...
const TodayPicks = props => {
    ...
    const loadNFTs = async (init) => {
        const new_nfts = await actions.getNFTs(collection.col_name, init?0:loaded, 16);        
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="wrap-box explore-1 flex mg-bt-40">
                            ...
                            <div className='collection-header'>
                                <span>{numberWithCommas(collection.total_supply)} tokens</span>
                            </div>
                    ...
                    }
                    {
                        ...
                        <div className="col-md-12 wrap-inner load-more text-center"> 
                            <Link to="#" id="load-more" className="sc-button loadmore fl-button pri-3" onClick={() => loadNFTs(0)}><span>Load More</span></Link>
                        </div>
                    }
                </div>
            </div>}
